...
PARAM_SECTIONS = [
    {
        ...
        "params": [
            ParamDef("entry_speed_kms", "Скорость входа", "км/с",
                     min_val=24.0, max_val=35.0, default=30.0, step=0.5, fmt=".1f",
                     desc="Скорость зонда на границе атмосферы (~500 км)"),
            ParamDef("entry_angle_deg", "Угол входа", "°",
                     min_val=1.0, max_val=35.0, default=5.0, step=0.5, fmt=".1f",
    ...
    },
    {
        ...
        "params": [
            ParamDef("mass_kg", "Масса зонда", "кг",
                     min_val=200.0, max_val=800.0, default=500.0, step=10.0, fmt=".0f",
                     desc="Полная масса зонда включая тепловой щит"),
            ParamDef("cone_radius_m", "Радиус конуса", "м",
                     min_val=0.4, max_val=2.5, default=0.798, step=0.05, fmt=".3f",
            ...
            ParamDef("cl_vehicle", "Коэфф. подъёмной силы", "",
                     min_val=0.0, max_val=0.5, default=0.1, step=0.01, fmt=".2f",
                     desc="C_L — подъёмная сила аппарата"),
            ParamDef("r_nose_m", "Радиус затупления", "м",
                     min_val=0.5, max_val=3.0, default=1.5, step=0.1, fmt=".1f",
                     desc="Радиус носовой части (для расчёта теплового потока)"),
        ],
    },
    {
